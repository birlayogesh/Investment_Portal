...
<html:body bgcolor="#ECBE6C">
	<html:form action="/login/actionBuySell">
		...
		<h2 style="color: red;margin-top: -25px;">MAKE A TRANSACTION - Additional Purchase</h2>
		</div>
...
session.removeAttribute("errorMessage");
				...
				<td><select id="companyName" name="companyName"
					...
					<%
						DBConnectivity dbc = new DBConnectivity();
									String abc[] = (String[]) dbc.getStockCompanyInfo();
									int i = 0;
		...
		<table border="2px" style="width: 50%;">
			...
			<tr>
				<td colspan="2"><input type="submit" value="BUY" onclick="disclaimer5();" > &nbsp;&nbsp;&nbsp;&nbsp; <a
					href="">RESET</a></td>
			</tr>
		</table>
	</html:form>
